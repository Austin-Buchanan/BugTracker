...
class Bug {
    private $bugID, $userID, $swName, $urgency, $shortDesc, $longDesc, $timeCreated, $timeModified;

    public function __construct($bugID_in, $userID_in, $swName_in, $urgency_in, $shortDesc_in, $longDesc_in, $timeCreated_in, $timeModified_in) {
        $this->bugID = $bugID_in;
